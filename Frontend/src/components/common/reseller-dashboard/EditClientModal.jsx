        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-[1px]">
            <div className="bg-white rounded-2xl shadow-xl w-full max-w-md mx-4">
                <div className="flex items-center justify-between px-6 py-4 bg-blue-500 rounded-t-2xl">
                    <h3 className="text-white font-semibold">Update Client</h3>
                ...
                <div className="p-6 space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                            <label className="block text-xs font-semibold text-slate-700 mb-1">Licenses * <span className="text-slate-400 font-normal">(max {licenses.leftOverLicenses + client.totalUsers})</span></label>
                ...
                <div className="flex justify-end gap-2 px-6 py-4 border-t">
                    <Button variant="outline" onClick={() => setModal("editModalOpen", false)}>Cancel</Button>
                    <Button className="bg-blue-500 hover:bg-blue-600" onClick={handleSubmit} disabled={saving}>{saving ? "Updating..." : "Update Client"}</Button>
                </div>
            </div>
        </div>
    );
