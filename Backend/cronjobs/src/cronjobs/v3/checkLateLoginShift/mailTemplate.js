            ...
            <tr>
                <td style="padding: 10px 0 30px 0;">
                    <table align="center" bgcolor="#f4f7fe" border="0" cellpadding="0" cellspacing="0" width="600"
                        ...
                        <tr>
                            <td align="center" >
                                <img width="200px" src="https://app.empmonitor.com/assets/images/logos/305b8a5fe69af674908f8b7ca5816faa.png" style="margin-top:20px;" />
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: center; margin-bottom:30px">
                                    <tr >
                                        <td
                                            ...
                                            Please find the attachment below regarding EmpMonitor Absent User List
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
