module.exports = function getHtmlTemplate({ resellerData }) {
    const logoLink = resellerData?.logo ?? "https://app.empmonitor.com/assets/images/logos/323176aaf7bb6da5259e901f3b81bdcc.png";
    return `
    <html xmlns="http://www.w3.org/1999/xhtml">
                <head></head>
                <body bgcolor="#f8f8f8"></body>
                </html>
                <title>${resellerData?.brand_name ?? process.env.BRAND_NAME}</title>
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                <img src = "${logoLink}" style="max-height: 30%; max-width: 42%;"/>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody>
                                                                                </table>
                                                                                ...
                                                                                <table align="center" border="0" cellpadding="0"
                                                                                    ...
                                                                                    <tbody>
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                class="center"
                                                                                                style="margin: 0; padding-bottom:15px; margin:0; font-family: Lucida Sans Unicode; font-size: 18px; color: #0d1a2b; line-height:1.4;padding: 18px;mso-line-height-rule: exactly;">
                                                                                                Your configuration for the Screenshots store has expired. Please update storage details in the admin account to continue using our service.</td>
                                                                                        </tr>
                                                                                        <!-- END OF HEADING-->
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center" class="center"
                                                                                                style="margin: 0; margin:0; font-family: Lucida Sans Unicode; font-size: 16px; color: #0d1a2b; line-height: 1.4;mso-line-height-rule: exactly;">
                                                                                                <span>Regards,<br /> ${resellerData?.brand_name ?? process.env.BRAND_NAME}
                                                                                                    Support,<br />
                                                                                                    ${resellerData?.support_mail ?? process.env.SUPPORT_EMAIL}<br /> Skype:
                                                                                                    ${resellerData?.skype_email ?? process.env.SKYPE_EMAIL} </span></td>
                                                                                        </tr> <!-- END oF Cong -->
                                                                                        <!-- START OF BUTTON-->
                                                                                        <tr>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <span><a href="${resellerData?.facebook ?? process.env.FACEBOOK}"
                                                                                                target="_blank" style="background-color: #3b5998; color: #ffffff; padding: 10px">
                                                                                                Facebook
                                                                                            </a> &nbsp; <a
                                                                                                href="${resellerData?.twitter ?? process.env.TWITTER}"
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td height="40"
                                                                ...
                                                                width="100%">Copyright &copy; 2017 - ${new Date().getFullYear()} ${resellerData?.brand_name ?? process.env.BRAND_NAME}. All Rights
                                                                Reserved.</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
