module.exports.emailTemplate = ({
    ...
    sellerMailChangesObj, reportLink, timesheetHtmlTable = ''
}) => `
<!DOCTYPE>
<html>
                    ...
                    <tr>
                        <td align="center" border="0" cellpadding="0" cellspacing="0" width="650">
                            <div style="display: ${reportLink ? '' : 'none'}">
                                <a href='${reportLink}'> Click here </a> to download report
                            </div>
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="text-align: center;">
                                <tr>
                                    <td
                                        ...
                                        <span ${findMoreLink ? '' : "style='display:none'"}>
                                            <a style="color: #adddfb;" href="${findMoreLink}">${findMoreStr}</a><br>
                                        </span>
