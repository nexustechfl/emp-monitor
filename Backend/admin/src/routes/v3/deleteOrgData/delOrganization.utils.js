...
exports.sendEmail = async ({ email, name, code, message }) => {
    ...
    const msg = {
        ...
        bcc: process.env.EMAIL_ORGANIZATION_DATA_DELETE_BCC,
        subject: "OTP for Delete Organization Data",
        text: "OTP for Delete Organization Data",
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                Hello ${name}, Your OTP for ${message} is <br><br><strong>${code}</strong></td>
                                                                                        </tr>
                                                                                        <tr><td></td></tr>
                                                                                        <tr>
                                                                                            <td align="center"
                                                                                                ...
                                                                                                OTP will be valid for 10 minutes.</td>
                                                                                        </tr>
                                                                                        <!-- END OF HEADING-->
                                                                                        <tr><td><br></td></tr>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td height="40"
                                                                ...
                                                                width="100%">Copyright &copy; 2017 - ${new Date().getFullYear()} EmpMonitor. All Rights
                                                                Reserved.</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
