module.exports = ({ supportText, footerHide, facebookHide, twitterHide, redirectlink, message, rightsMessage, buttonMessage, logo, facebook, copyright_year, twitter, skype_email, regards, brand_name, support_mail, StayInTouch }) => {
                                                            ...
                                                            <tr>
                                                                <td style="padding: 0px;" valign="middle" width="600">
                                                                    <table align="center" border="0" cellpadding="0"
                                                                        ...
                                                                        margin: 2rem 8rem;
                                                                        color: #ffffff;
                                                                        border-radius: 8px;">${buttonMessage}</h3>
                                                                                </a> </tr> <!-- END oF Cong -->
                                                                            <!-- START OF BUTTON-->
                                                                            <!-- START OF Cong-->
                                                                            <tr>
                                                                                <td align="center"
                                                                                    class="center"
                                                                                    style="margin: 0; padding-bottom:15px; margin:0; font-family: Times New Roman; font-size: 18px; color: #0d1a2b; line-height: 25px;mso-line-height-rule: exactly;">
