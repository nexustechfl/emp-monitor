...
class Mail {
    ...
    async sendMail(email, message, subject, name, password, role, cb) {
        ...
        sgMail
            .send(msg)
            .then(data => {
                Logger.info(`-----Mail sent to ${email} in AlertHandlerBase-------`)
                cb(null, data);
            })
            .catch(err => {
                Logger.error(`-----Mail sending failed in sendMail for ${email}-------`, err)
                cb(err, null);
            })
    }

    async sendEMail({ findMoreLink, yourUserId, hello, youPassword, LoggedAt, email, message, subject, name, password, role, footerHide, facebookHide, twitterHide, rightsMessage, buttonMessage, logo, facebook, copyright_year, twitter, skype_email, regards, brand_name, support_mail, StayInTouch, Support, admin_email, username, is_client,silahCustomTemplate = false }) {
        sgMail.setApiKey(process.env.SENDGRID_API_KEY);
        const msg = {
            to: email,
            from: admin_email,
            ...
            subject: subject,
            text: subject,
            html: !silahCustomTemplate ? `<html xmlns="http://www.w3.org/1999/xhtml">
                                                                ...
                                                                <table align="center" border="0" cellpadding="0"
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        style="padding: 40px 0 30px 0; "
                                                                            >
                                                                        <img src="${logo}" alt="Logo" width="120px" height="30" >
                                                                        </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td align="center"
                                                                                ...
                                                                                ${hello} ${name} ${message ? message : ''}</td>
                                                                        </tr>
                                                                        <!-- END OF HEADING-->
                                                                        <!-- START OF Cong-->
                                                                        <tr>
                                                                            ${role == 'M' ? `<td align="left"
                                                                                class="left"
                                                                                style="margin: 0; padding-bottom:15px; margin:0; font-family: Lucida Sans Unicode; font-size: 16px; color: #0d1a2b; line-height: 25px;mso-line-height-rule: exactly;">
                                                                                <br />
                                                                                <strong>${yourUserId}</strong>:
                                                                                ${username ? username : email}<br />
                                                                                <strong>${youPassword}</strong>:
                                                                                ${password}<br />
                                                                                ${LoggedAt}: <a
                                                                                   href=${findMoreLink}${is_client ? '/admin-login' : '/login'}>Log-In</a>
                                                                            </td>` : ' '}
                                                                        </tr> <!-- END oF Cong -->
                                                                        <!-- START OF BUTTON-->
                                                                        <!-- START OF Cong-->
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        ...
                                                                        <span ${facebook ? '' : "style='display:none'"}><a ${facebookHide} href="${facebook}"
                                                                                ...
                                                                                Facebook
                                                                            </a> </span>&nbsp;<span ${twitter ? '' : "style='display:none'"}> <a
                                                                            ${twitterHide}
                                                                                href="${twitter}"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td height="40"
                                                ...
                                                width="100%">Copyright &copy; ${copyright_year} ${brand_name}.  ${rightsMessage}.</td>
                                        </tr>
                                    </tbody>
                                </table>
                                                            ...
                                                            <td>
                                                                ...
                                                                <table align="center" border="0" cellpadding="0"
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        style="padding: 40px 0 30px 0; "
                                                                            >
                                                                        <img src="${logo}" alt="Logo" width="160px" height="40" >
                                                                        </td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                            ...
                            <td width="100%">
                                <table bgcolor="#1D6AD2" border="0" cellpadding="0" cellspacing="0" class="table_scale"
                                    ...
                                    <tbody>
                                        <tr>
                                            <td width="100%">
                                                <table  bgcolor="#ffe6e8" border="0" cellpadding="0" cellspacing="0"
                                                    width="600">
                                                    <tbody>
                                                        <tr>
                                                            <td style="padding: 0px;" valign="middle" width="600">
                                                                <table align="center" border="0" cellpadding="0"
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        <tr>
                                                                            ${role == 'M' ? `<td align="left"
                                                                                class="left"
                                                                                style=" padding: 10px; margin: 0; padding-bottom:15px; font-family: Lucida Sans Unicode; font-size: 16px; color: #0d1a2b; line-height: 25px;mso-line-height-rule: exactly;">
                                                                                <br />
                                                                                <strong>${yourUserId}</strong>:
                                                                                ${username ? username : email}<br />
                                                                                <strong>${youPassword}</strong>:
