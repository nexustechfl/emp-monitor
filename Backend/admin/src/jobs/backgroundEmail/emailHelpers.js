...
exports.sendEMail = async ({ email, message, subject, name, password, role }) => {
    // return;
    sgMail.setApiKey(process.env.SENDGRID_API_KEY);
    const msg = {
        to: email,
        from: process.env.EMP_ALERT_ADMIN_EMAIL,
        subject: subject,
        text: subject,
                                                                                    ...
                                                                                    <tbody>
                                                                                        ...
                                                                                        <tr>
                                                                                            ${role == 'M' ? `<td align="left"
                                                                                                ...
                                                                                                ${password}<br />
                                                                                                Log-on to your Account at: <a
                                                                                   href=${process.env.NODE_ENV === 'production' ? process.env.WEB_PRODUCTION + '/login' : process.env.WEB_DEV + '/login'}>Log-In</a>
                                                                                            </td>` : ' '}
                                                                                        </tr> <!-- END oF Cong -->
                                                                                        <!-- START OF BUTTON-->
                                                                                        <!-- START OF Cong-->
