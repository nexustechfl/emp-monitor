...
const TimelineDeleteSchema = new Schema({
...
TimelineDeleteSchema.index({ organization_id: 1, employee_id: 1 });
TimelineDeleteSchema.index({ organization_id: 1, employee_id: 1, date: 1 });

const TimelineDeleteSchemaModel = mongoose.model('timeline-delete-records', TimelineDeleteSchema);
